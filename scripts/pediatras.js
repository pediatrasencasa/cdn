...
$(document).ready(function () {
    ...
    // Preloader
    $("#preloaderKDZ").delay(400).fadeOut(800);
    ...
    //  Portfolio 
    if ($(".portfolio-filter").length > 0 && typeof (isotope) != 'undefined') {
    ...
    (function ($) {
        ...
        if (typeof (nivoLightbox) == 'undefined') return;
